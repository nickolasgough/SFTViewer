 ...
 * @author nvg081
 */
public class PaneThumbnail extends JComponent implements MouseListener, ComponentListener{
	...
	/**
	 * The parent that contains this thumbnail.
	 */
	private ThumbsPanel parent;

	/**
	 * Constructor for the component.
	 * @param image - The image of the thumbnail to draw to the screen.
	 */
	public PaneThumbnail(Image image, int width, int height, int index, InterfaceController controller, ThumbsPanel parent){
	...
	public void mouseClicked(MouseEvent arg0) {
		if (arg0.getButton() == MouseEvent.BUTTON1){
			...
			this.controller.pageVisited("ThumbsColumn");
